...
import { Leaf, Map as MapIcon, BarChart3, FileText, Info } from 'lucide-react';
    ...
    <header className="sticky top-0 z-[500] w-full bg-white/80 backdrop-blur-md border-b border-slate-200 shadow-sm">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="bg-earth-600 hover:bg-earth-700 text-white px-4 py-2 rounded-lg text-sm font-bold transition-all shadow-sm">
            Iniciar Sesión
          </button>
        </div>
      </div>
